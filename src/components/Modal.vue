...
export default {
  ...
  data() {
    return {
      ...
      amount: null,
      type: "",
      total: JSON.parse(localStorage.getItem("total-balance")) || null,
      bankData: JSON.parse(localStorage.getItem("trans-data") || "[]"),
    };
  },
      ...
      if (this.handle == "debit") {
        ...
        let totalBalance = {
          total:
            ...
            JSON.parse(localStorage.getItem("total-balance")).total -
              this.amount,
        };
